...
public class FileQuery extends BaseParam {
    ...
    private String getQueryNickName;
    ...
    public String getGetQueryNickName() {
        return getQueryNickName;
    }

    public void setGetQueryNickName(String getQueryNickName) {
        this.getQueryNickName = getQueryNickName;
    }
}
